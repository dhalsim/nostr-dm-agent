...
import { create{{PASCAL_ALIAS}}, delete{{PASCAL_ALIAS}}, get{{PASCAL_ALIAS}}, list{{PASCAL_ALIAS}}s, update{{PASCAL_ALIAS}} } from './db';
    ...
    if (idRaw) {
      ...
      if (entry.kind === 'create') {
        return [
          `Draft #${id} [create]:`,
          '',
          formatCreateDraftTree(entry.input as Create{{PASCAL_ALIAS}}Draft),
          '',
      ...
      if (entry.kind === 'update') {
        return [
          `Draft #${id} [update]:`,
          `  target id: ${(entry.input as Update{{PASCAL_ALIAS}}Input).id}`,
          '',
